                        ...
                        Tab::make('Hình ảnh')
                            ->schema([
                                Section::make('Tải ảnh dịch vụ')
                                    ...
                                    ->schema([
                                        self::imageUpload('image_upload', 'Ảnh đại diện', 'services/featured'),
                                        self::imageUpload('secondary_image_upload', 'Ảnh phụ', 'services/gallery'),
                            ...
                            ->schema([
                                Section::make('Nội dung hiển thị')
                                    ->schema([
                                        ...
                                        Textarea::make('description')->label('Mô tả ngắn')->rows(4),
