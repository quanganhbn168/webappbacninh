      ...
      <div class="row g-4 align-items-start">
        <aside class="col-lg-3">
          <div class="legal-toc">
            ...
            <a class="btn btn-outline-primary w-100" href="<?= e(frontend_url('lien-he.php')) ?>">Cần giải thích thêm</a>
          </div>
        </aside>
        ...
        <div class="col-lg-9">
          ...
          <div class="legal-contact" data-aos="fade-up">
            ...
            <div class="legal-contact__actions">
              <a class="btn btn-primary" href="<?= e(frontend_url('lien-he.php')) ?>">Gửi yêu cầu</a>
