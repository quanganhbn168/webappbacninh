  ...
  <section class="project-detail-hero">
    <div class="container">
      <nav aria-label="breadcrumb" class="project-detail-breadcrumb" data-aos="fade-up">
        <ol class="breadcrumb mb-0"><li class="breadcrumb-item"><a href="<?= e(frontend_url('index.php')) ?>">Trang chủ</a></li><li class="breadcrumb-item"><a href="<?= e(frontend_url('du-an.php')) ?>">Dự án</a></li><li class="breadcrumb-item active" aria-current="page"><?= e($project['code']) ?></li></ol>
      </nav>
