<main>
  <section class="theme-detail-hero">
    <div class="container">
      <nav aria-label="breadcrumb" class="theme-breadcrumb" data-aos="fade-up">
        <ol class="breadcrumb mb-0"><li class="breadcrumb-item"><a href="<?= e(frontend_url('index.php')) ?>">Trang chủ</a></li><li class="breadcrumb-item"><a href="<?= e(frontend_url('kho-giao-dien.php')) ?>">Kho giao diện</a></li><li class="breadcrumb-item active" aria-current="page"><?= e($theme['code']) ?></li></ol>
      </nav>
        ...
        <div class="col-lg-4">
          <aside class="theme-order-card" data-aos="fade-left">
            ...
            <div class="d-grid gap-2">
              ...
              <a class="btn btn-outline-primary" href="tel:<?= e(site_config('phone_href')) ?>"><i class="fa-solid fa-phone"></i> Gọi <?= e(site_config('phone')) ?></a>
            </div>
  ...
  <section class="detail-section detail-section--light">
    <div class="container">
      <div class="row align-items-end gy-3 mb-5"><div class="col-lg-8"><span class="section-kicker">GIAO DIỆN LIÊN QUAN</span><h2 class="section-title mb-0">Tham khảo thêm các mẫu gần nhu cầu này</h2></div><div class="col-lg-4 text-lg-end"><a class="text-link" href="<?= e(frontend_url('kho-giao-dien.php')) ?>">Xem toàn bộ kho giao diện <i class="fa-solid fa-arrow-right"></i></a></div></div>
      <div class="theme-related-grid"><?php foreach ($relatedThemes as $related): ?><?php echo view('frontend.site.components.theme-card', ['theme' => $related, 'showQuick' => false]); ?><?php endforeach; ?></div>
    </div>
  </section>
  ...
  <section class="theme-detail-contact" id="themeConsult">
    <div class="container">
      <div class="theme-detail-contact__shell">
        ...
        <form action="<?= e(route('leads.store')) ?>" method="POST" data-lead-form class="theme-contact__form needs-validation" id="themeDetailForm" novalidate>
          <input type="hidden" name="need" id="selectedThemeCode" value="<?= e($theme['code']) ?>">
          <div class="row g-3">
