...
<head>
    ...
    <meta name="description" content="@yield('meta_description', $site_settings['site_description'] ?? 'Thiết kế web theo ngành nghề, chuẩn SEO, dễ dùng và tối ưu chuyển đổi.')" />
    <meta name="keywords" content="@yield('meta_keywords', $site_settings['meta_keywords'] ?? 'thiết kế web, web bắc ninh, website bán hàng, web tuyển sinh, landing page')" />
    ...
    <meta property="og:description" content="@yield('meta_description', $site_settings['site_description'] ?? 'Thiết kế web theo ngành nghề, chuẩn SEO, dễ dùng và tối ưu chuyển đổi.')" />
    ...
    <meta name="twitter:description" content="@yield('meta_description', $site_settings['site_description'] ?? 'Thiết kế web theo ngành nghề, chuẩn SEO, dễ dùng và tối ưu chuyển đổi.')">
