...
<head>
    @php
        ...
        $utilityImagePath = trim($__env->yieldContent('meta_image')) ?: ($site_settings['default_og_image'] ?? 'images/default-og.jpg');
        $utilityImage = site_asset_url($utilityImagePath, 'images/default-og.jpg');
    @endphp
    <meta charset="UTF-8">
