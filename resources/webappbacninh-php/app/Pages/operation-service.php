...
$services = require base_path('app/Data/operation_services.php');
...
$canonicalUrl = rtrim((string) config('site_url'), '/') . '/' . pathinfo($service['route'], PATHINFO_FILENAME);
...
view('operations.show', compact('service'));
