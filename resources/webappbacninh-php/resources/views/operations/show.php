      ...
      <div class="row align-items-center gy-5">
        <div class="col-lg-6" data-aos="fade-up">
          ...
          <div class="operation-detail-hero__actions">
            ...
            <a class="btn btn-outline-dark btn-lg" href="<?= e(url('dich-vu-van-hanh.php')) ?>">Xem toàn bộ dịch vụ</a>
          </div>
        ...
        <div class="col-lg-6" data-aos="fade-left">
          <div class="operation-detail-hero__media">
            <img src="<?= e(asset($service['image'])) ?>" alt="<?= e($service['title']) ?>" width="1200" height="800">
      ...
      <div class="row align-items-center gy-5">
        <div class="col-lg-6" data-aos="fade-right">
          <div class="operation-deliverables__media">
            <img src="<?= e(asset($service['secondary_image'])) ?>" alt="Phạm vi bàn giao <?= e($service['eyebrow']) ?>" width="1200" height="800">
          </div>
        </div>
        <div class="col-lg-6" data-aos="fade-left">
