  ...
  <section class="projects-hero">
    <div class="container">
      <nav aria-label="breadcrumb" class="projects-breadcrumb" data-aos="fade-up">
        <ol class="breadcrumb mb-0"><li class="breadcrumb-item"><a href="<?= e(url('index.php')) ?>">Trang chủ</a></li><li class="breadcrumb-item active" aria-current="page">Dự án</li></ol>
      </nav>
      ...
      <div class="projects-grid" id="projectsGrid">
        ...
        <article class="project-showcase-card <?= $index === 0 ? 'project-showcase-card--featured' : '' ?>"
          ...
          <a class="project-showcase-card__media" href="<?= e(project_url($project)) ?>">
            <img src="<?= e(asset($project['image'])) ?>" alt="<?= e($project['title']) ?>" width="1200" height="750" loading="lazy">
  ...
  <section class="projects-contact" id="projectContact">
    <div class="container">
      <div class="projects-contact__shell" data-aos="fade-up">
        ...
        <form class="projects-contact__form needs-validation" novalidate id="projectForm">
          <div class="row g-3">
            <div class="col-md-6"><label class="form-label" for="projectName">Họ và tên *</label><input class="form-control" id="projectName" required></div>
            <div class="col-md-6"><label class="form-label" for="projectPhone">Số điện thoại *</label><input class="form-control" id="projectPhone" type="tel" required></div>
            <div class="col-md-6"><label class="form-label" for="projectIndustry">Lĩnh vực</label><input class="form-control" id="projectIndustry" placeholder="Sản xuất, giáo dục, thương mại..."></div>
            <div class="col-md-6"><label class="form-label" for="projectReference">Dự án tham khảo</label><input class="form-control" id="projectReference" placeholder="Ví dụ: DA-001"></div>
            <div class="col-12"><label class="form-label" for="projectMessage">Mô tả nhu cầu</label><textarea class="form-control" id="projectMessage" rows="4"></textarea></div>
