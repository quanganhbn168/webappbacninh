      ...
      <div class="row align-items-center gy-5">
        ...
        <div class="col-lg-6">
          <div class="service-detail-hero__visual" data-aos="fade-left">
            <img src="<?= e(asset($service['image'])) ?>" alt="<?= e($service['title']) ?>" width="1200" height="750">
      ...
      <div class="row align-items-center gy-5">
        <div class="col-lg-5" data-aos="fade-right">
          <div class="service-intro-media">
            <img src="<?= e(asset($service['secondary_image'])) ?>" alt="Minh họa <?= e($service['eyebrow']) ?>" width="1200" height="800">
  ...
  <section class="section">
    <div class="container">
      <div class="row gy-5 align-items-start">
        <div class="col-lg-5" data-aos="fade-right"><span class="section-kicker">CÂU HỎI THƯỜNG GẶP</span><h2 class="section-title">Làm rõ trước khi bắt đầu</h2><p class="section-lead">Phần còn phụ thuộc dữ liệu hoặc hệ thống hiện tại sẽ được khảo sát trước khi báo giá chính thức.</p><a class="btn btn-outline-primary" href="<?= e(url('lien-he.php')) ?>">Gửi câu hỏi khác</a></div>
        <div class="col-lg-7" data-aos="fade-left">
